  ...
  return (
    <div className="max-w-7xl mx-auto">
      ...
      <div className="text-center mb-16">
        ...
        <p className="text-xl sm:text-2xl text-default-600 mb-2">
          GPS Route Tracking App
        </p>
        <p className="text-lg text-default-500 max-w-2xl mx-auto mb-8">
          Track your journeys with high-precision GPS, save routes locally, and
          view detailed statistics. Built for accuracy, designed for simplicity.
        </p>
        <Button
          as={Link}
          to="/routes"
      ...
      <div className="mb-16">
        <div className="text-center mb-10">
          ...
          <p className="text-default-500 max-w-xl mx-auto">
            Everything you need for accurate GPS route tracking, right in your
            browser.
          </p>
        </div>
      ...
      <div className="mb-16">
        <div className="text-center mb-10">
          ...
          <p className="text-default-500 max-w-xl mx-auto">
            Simple four-step process to track and save your routes.
          </p>
        </div>
      ...
      <Card className="bg-primary/5 border border-primary/20">
        <CardBody className="py-10 text-center">
          ...
          <p className="text-default-500 mb-6 max-w-lg mx-auto">
            Start recording your routes today. No sign-up required, all data
